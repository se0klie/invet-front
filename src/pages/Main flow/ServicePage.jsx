        ...
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
                ...
                >
                    <Box
                        component="img"
                        src={`${import.meta.env.VITE_BASE_URL}/images/services/pet1-services.jpg`}
                        alt="Perro"
                        sx={{
                            width: { xs: 200, md: 300 },
                    ...
                    {!isMobile &&
                        <Box
                            component="img"
                            src={`${import.meta.env.VITE_BASE_URL}/images/services/cat1-services.jpg`}
                            alt="Gato"
                            sx={{
                                width: { xs: 200, md: 250 },
                ...
                >
                    <Box
                        sx={{
                            ...
                            backgroundImage: `url('${import.meta.env.VITE_BASE_URL}/images/services/doc-servicio.jpg')`,
